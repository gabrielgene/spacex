...
export type LaunchesQueryVariables = Exact<{
  limit?: InputMaybe<Scalars['Int']>;
  missionName?: InputMaybe<Scalars['String']>;
  offset?: InputMaybe<Scalars['Int']>;
}>;
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'details' } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'flickr_images' },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'mission_patch_small' },
                      },
                      {
                        kind: 'Field',
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'video_link' },
                      },
                    ],
                  },
                },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'missionName' },
          },
